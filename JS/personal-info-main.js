...
$(function () {
    if (config) {
        ...
        $(".strFormContentJob").html(config.strFormContentJob);
        ...
        $(".strFormContentWorkHistory").html(config.strFormContentWorkHistory);
        $(".strFormContentMyStory").html(config.strFormContentMyStory);

        // right Copy
        $(".strCopyright").html(config.strCopyright);
    ...
    // ---- 座右铭字缓出效果 -----
    var text = "I am not only a Developer, but the Creator of the Era";
